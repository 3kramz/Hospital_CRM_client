          ...
          <div className="absolute w-[960px] h-[1064px] top-[77px] left-[312px] bg-neutral-100 rounded-md shadow-md px-6 py-10">
            ...
            <div className="bg-[#c9e7ff] rounded-lg p-6 mb-6 space-y-4 mt-20">
              <div className="grid grid-cols-2 gap-y-2 text-xl font-semibold">
                ...
                <div className="flex">
                  ...
                  <span>{patientInfo?.time || "N/A"}</span>
                </div>
                <div className="flex">
            ...
            />
                ...
                <div className="flex">
                  ...
                  <span>{patientInfo.refDoctor || "N/A"}</span>
                </div>
                <div className="flex">
                  <span className="w-40">MOBILE:</span>
                  <span>{patientInfo.contact || "N/A"}</span>
                </div>
              </div>
            </div>
            ...
            <div className="text-xl text-right pr-6 space-y-1 mb-4">
              <p>Total: {total.toFixed(2) || "N/A"}</p>
              <p>Discount: {totalDiscount.toFixed(2) || "N/A"}</p>
              <p>VAT: {vat.toFixed(2) || "N/A"}</p>
              <p>Previous Due: {previousDue.toFixed(2) || "N/A"}</p>
              <p className="font-bold">Final Total: {grandTotal.toFixed(2) || "N/A"}</p>
              <p>Payment: {payment.toFixed(2) || "N/A"}</p>
              <p className="text-red-600 font-bold">
                Due: {updatedDue.toFixed(2) || "N/A"}
              </p>
            </div>
